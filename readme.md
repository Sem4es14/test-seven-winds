...
1. Все поставленные задачи.
2. Произведен рефакторинг с разбиением dto моделей по отдельным классам.
3. Добавлены зависимости позволяющие работать со временем в Entity.
4. Версия ktor-exposed вынесена в gradle.properties.
5. Реализованный функционал покрыт тестами.